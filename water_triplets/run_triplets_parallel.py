...
# ----------------------------------------------------------------------
#  2) convenience variables / sanity checks
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
#  3) enumerate residues or custom groups
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
def run_cmd(cmd):
    """Run a shellless subprocess and return (returncode,cmd)."""
...
# ----------------------------------------------------------------------
#  5) parallel execution with progress
# ----------------------------------------------------------------------
start = time.time()
fails = []
...
with ProcessPoolExecutor(max_workers=args.nprocs) as pool:
    ...
    for fut in as_completed(futures):
        ...
        # crude progress ‑ avoids extra deps
